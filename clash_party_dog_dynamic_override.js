...
// 目标：保留订阅节点及其他原始配置，优化 DNS fallback 链路，并使用目标文件的代理组、规则集和规则。
...
const FALLBACK_FILTER_DOMAINS = ["+.google.com", "+.facebook.com", "+.twitter.com", "+.youtube.com", "+.xn--ngstr-lra8j.com", "+.google.cn", "+.googleapis.cn", "+.googleapis.com", "+.gvt1.com"];
